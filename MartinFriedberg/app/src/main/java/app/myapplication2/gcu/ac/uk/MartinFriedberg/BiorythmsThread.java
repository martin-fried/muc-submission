 ...
 */
public class BiorythmsThread  extends Thread
{
    ...
    private BiorythmsSurfaceView bioSF;

    public BiorythmsThread(SurfaceHolder surfaceHolder, BiorythmsSurfaceView bioSurfV) {
